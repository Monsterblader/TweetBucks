...
For front-end only development, I use an IDE that has a live-update plug in for Chrome.  It can generate projects from boiler plates, so I used the built-in Angular generator.
